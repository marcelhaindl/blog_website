...
<template>
  ...
  <div class="info-box not-prose" :class="[type]">
    ...
    <ExclamationTriangleIcon v-if="type == 'warning'" class="icon solid w-8" />
    <ExclamationCircleIcon v-else-if="type == 'error'" class="icon solid w-8" />
    <InformationCircleIcon v-else class="icon solid w-8" />
